...
import { Text, Container, Content, Header, Icon, Button, Title, Footer, Left, Right, Body, FooterTab, Toast } from "native-base";
...
class ChangePasswordScreen extends Component {
    ...
    componentDidMount() {
        let isForgot = this.props.navigation.getParam("isForgot", null)
        this.setState({ isVisible: isForgot })
                    ...
                    SuccessCallback: res => {
                        ...
                        if (res.data) {
                            if (res.data.response.data.message) {
                                ...
                                Toast.show({
                                    text: res.data.response.data.error,
                                    position: "bottom",
                                    type: "warning",
                                    duration: 3000
                                  })
